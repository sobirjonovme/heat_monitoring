...
from apps.chicken_farm.utils.daily_reports_update import bulk_update_daily_reports
...
class HelperAPIView(APIView):
    def get(self, request, format=None):
        ...
        print(f"\n\n\tSold egg boxes: {a}\n\n")
        print("\n\nbefore annotate\n\n")
        sales_reports = sales_reports.annotate_sold_egg_boxes()
        print("\n\nafter annotate\n\n")
        print(sales_reports)
        print("\n\nbefore for\n\n")
        for a in sales_reports:
            print(a.sold_egg_boxes1)
